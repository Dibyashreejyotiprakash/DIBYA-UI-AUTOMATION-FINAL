...
public class InteractionUtility extends Base{
	...
	public void enter(By by)
	{
		try {
			...
			e.printStackTrace();
			ExtentReport.logFailWithError("Enter failed due to :", e);
		}
	}
	...
	public String getText(By by)
	{
		...
		try {
			...
			e.printStackTrace();
			ExtentReport.logFailWithError("Get text failed due to :", e);
		}
		return text;
	}
	...
	public String generateRandonString(String text)
	{
		...
		try {
			...
			newcategoryname = text + currenttime;
		}
		catch(Exception e) {
			e.printStackTrace();
			ExtentReport.logFailWithError("Generate Randon String failed due to :", e);
		}
